    ...
    <section className="px-6 bg-white/50 backdrop-blur-sm" style={{ padding: 'clamp(80px, 12vh, 150px) 24px' }}>
      <div className="max-w-[980px] mx-auto text-center">
        ...
        <ScrollReveal delay={0.4} className="mt-10">
          <p className="text-finbrief-gray-500 max-w-[680px] mx-auto" style={{ fontSize: 'clamp(18px, 2.5vw, 24px)' }}>
...
function FeatureShowcase() {
  ...
  return (
    <section className="px-6 bg-finbrief-black" style={{ padding: 'clamp(80px, 12vh, 150px) 24px' }}>
          ...
          {steps.map((step, index) => (
            <StaggerItem key={index}>
              <div className="flex items-start gap-6 mb-12 last:mb-0">
                <div className="flex-shrink-0 rounded-full bg-finbrief-gray-100 flex items-center justify-center" style={{ width: '72px', height: '72px' }}>
...
function CTASection() {
  ...
  return (
    <section id="subscribe" className="px-6 bg-cta-gradient" style={{ padding: 'clamp(80px, 12vh, 150px) 24px' }}>
      <div className="max-w-[980px] mx-auto text-center">
        <ScrollReveal>
          <h2 className="text-finbrief-white mb-4" style={{ fontSize: 'clamp(32px, 6vw, 64px)' }}>
            내일 아침부터 시작하세요
          </h2>
          <p className="mb-10 max-w-[680px] mx-auto" style={{ fontSize: 'clamp(18px, 2.5vw, 24px)', color: 'rgba(255,255,255,0.7)' }}>
      ...
      <div className="max-w-[980px] mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 text-sm text-finbrief-gray-500">
            ...
            <a href="/privacy" className="hover:text-finbrief-black transition-colors">
              개인정보처리방침
            </a>
            <a href="/terms" className="hover:text-finbrief-black transition-colors">
              이용약관
            </a>
          </div>
        </div>
